...
def main():
    ...
    for mice_num in mice_nums:
        ...
        warp_field_75 = nib.load(raw_path+ '/new_model_predicted_atlas_warpfield_'+str(mice_num)+'.nii')
        ...
        nib.save(nifti_img, datapath+ 'step1_vm/vm_warped_atlas_25um_predicted.nii.gz')
        ...
        nib.save(nifti_img, datapath+ 'step1_vm/vm_warped_anno_25um_predicted.nii.gz')
