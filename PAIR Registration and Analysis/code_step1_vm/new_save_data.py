...
def main():
    ...
    for mice_num in mice_nums:
        ...
        raw_path = path_before_hd6 + '/xxx/xxx/Data/2024/240926_align/vxm_evaluation_new/'+str(mice_num)+'/'
        ...
        warp_field_75 = nib.load(raw_path+ '/new_model_optimized_atlas_warpfield_'+str(mice_num)+'.nii')
