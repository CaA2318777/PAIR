...
fixed_path = '/home/xxx/LabFiles1/xxx/xxx/Data/2024/240926_align/' + str(mice_num) + '/'+str(resolution) +'um/'+ '/origin/' + '/Atlas_25um.nii.gz'
moving_path = '/home/xxx/LabFiles1/xxx/xxx/Data/2024/240926_align/' + str(mice_num) + '/'+str(resolution) +'um/'+ '/origin/' + '/ims_data_25um.nii.gz'
saving_path = '/home/xxx/LabFiles1/xxx/xxx/Data/2024/240926_align/' + str(mice_num) + '/'+str(resolution) +'um/'+ '/traditional_clearmap/'
...
# sitk.WriteImage(image, saving_path + 'clearmap_warped_ims_' + str(resolution) +'um.nii.gz')
...
if ifresult:
    ...
    sitk.WriteImage(image, saving_path + 'clearmap_warped_ims_result_' + str(resolution) +'um.nii.gz')