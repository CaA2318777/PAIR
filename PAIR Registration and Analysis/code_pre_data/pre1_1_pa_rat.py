...
fixed1 = ants.image_read(path_before_hd6 + '/xxx/xxx/HD1/atlas_rat_dataset/atlas.nii.gz')
fixed1 = fixed1.numpy()
print(fixed1.shape)
down_factor = 39/75
fixed = zoom(fixed1, zoom=(down_factor, down_factor, down_factor), order=1) 
nib.Nifti1Image(fixed,np.eye(4)).to_filename(datapath + 'atlas_75um.nii.gz')



fixed = ants.image_read(datapath + 'atlas_75um.nii.gz')
...
if 1:#not os.path.exists(datapath + 'pa_rigid_Generic_Affine.mat'):
